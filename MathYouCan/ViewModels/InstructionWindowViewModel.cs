...
namespace MathYouCan.ViewModels
{
    internal class InstructionWindowViewModel : INotifyPropertyChanged
    {
        ...
        {
            string instructionText1 = "<strong>IMPORTANT:</strong> Read this information before selecting the <strong>Next</strong> button.\n\n" +
            ...
            string instructionText2 = "<strong> IMPORTANT: </strong> Read this information before selecting the <strong> Next</strong> button.\n\n" +
                ...
                "  <strong> • </strong>  You may not access an electronic device, other than your testing computer and " +
                ...
                "  <strong> • </strong>  You may not give or receive assistance by any means. This includes looking at another" +
                "person's computer or scratch paper.\n  <strong> • </strong>  You are not allowed to use any notes, dictionaries, or other aids." +
                "\n  <strong> • </strong>  You may use only the scratch paper provided to you.\n  <strong> • </strong>  You may not allow an alarm to sound in the test room or create any ither disturbance. " +
                ...
                "  <strong> • </strong>  Finally, eating, drinking, and the use of tabacco or reading materials are not permitted " +
            ...
            string instructionText3 = "<strong> IMPORTANT:</strong> Read this information before selecting the <strong>Next</strong> button.\n\n" +
                ...
                "measure skills and abilities highly related to high school course work and success in college. <strong> Calculators may " +
                "be\nused on the mathematics only </strong> .\n\nFor each multiple-choice question, " +
                ...
                "<strong> Next </strong> button to move to the next question. For the\nwriting test, type your essay into the " +
                "text box below the writing prompt and select the <strong>Next </strong> button when finished.\n\nYour score on each multiple-choice test will be based only on " +
                "the number of question you answered correctly during the time\nallowed for that test. You will <strong> not </strong> be penalized for guessing. " +
                "<strong> It is to your advantage to answer every " +
                "question</strong>. Your score on\nthe writing test is based on the essay you type into the text box.\n\n" +
                ...
                "your essay. You will <strong> not </strong> be able to look back at the test questions or the essay once the test is submitted.\n\n" +
            ...
            string instructionText4 = "By accessing the online test, I agree to comply with and be bound by the <i> Terms and " +
                ...
                "im the United States.\n\nBy selecting <strong> Accept</strong> below and/or accessing the online test, I confirm my acceptance of the above terms.";
