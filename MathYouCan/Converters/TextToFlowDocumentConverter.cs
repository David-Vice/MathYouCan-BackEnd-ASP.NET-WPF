...
namespace MathYouCan.Converters
{
    public class TextToFlowDocumentConverter
    {
        ...
        public TextToFlowDocumentConverter(Brush selectedTextColor)
        {
        ...
        {
            HtmlTextToParagraphConverter textConverter = new HtmlTextToParagraphConverter(_selectedTextColor);
            textConverter.Convert(paragraph, text, fontSize);
