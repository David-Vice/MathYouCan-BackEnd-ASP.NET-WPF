...
namespace MathYouCan.Services.Concrete
{
    public class InfosAndInstructions
    {
        ...
        private string EngInfo = "|~B~|English Test Directions\n\nYou will have 45 minutes to complete this section. |~B~| \n " +
        ...
        private string MathInfo = "|~B~|Mathematics Test Directions\n\nYou will have 60 minutes to complete this section. |~B~|\n" +
        ...
        private string ScienceInfo = "|~B~| Science Test Directions\n\nYou will have 35 minutes to complete this section. |~B~|\n" +
        ...
        private string ReadingInfo = "|~B~| Reading Test Directions |~B~| \n" +
