...
namespace MathYouCan.Services.Concrete
{
    public class InfosAndInstructions
    {
        ...
        private string EngInfo = "|~B~|English Test Directions|~B~|\n\n|~B~|You will have 45 minutes to complete this section.|~B~|\n" +
        ...
        private string EngInst = "|~B~|Begin English Test—45 minutes, 75 questions|~B~|\n" +
        ...
        private string MathInfo = "|~B~|Mathematics Test Directions|~B~|\n\n|~B~|You will have 60 minutes to complete this section.|~B~|\n" +
            ...
            "You may use your scratch paper on this test. You will hand that in to the room supervisor at the end of testing.\n" +
            "Select the |~B~|Next|~B~| button to proceed.\n";
        private string MathInst = "|~B~|Begin Mathematics Test—60 minutes, 60 questions|~B~|\n\n" +
        ...
        private string ScienceInfo = "|~B~|Science Test Directions|~B~|\n\n|~B~|You will have 35 minutes to complete this section.|~B~|\n" +
            ...
            "You may use your scratch paper on this test. You will hand that in to the room supervisor at the end of testing.\n" +
            "Select the |~B~|Next|~B~| button to proceed.\n";
        private string ScienceInst = "|~B~|Begin Science Test—35 minutes, 40 questions|~B~|\n\n" +
        ...
        private string WritingInfo = "|~B~|Writing Test Directions|~B~|\n" +
            ...
            "Select the |~B~|Next|~B~| button to proceed.\n";
        private string WritingInst = "|~B~|Begin Writing Test—40 minutes|~B~|\n" +
